...
cc_window_class_init (CcWindowClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/io/github/gnome_de/ControlCenter/gtk/cc-window.ui");
...
cc_window_init (CcWindow *self)
{
  ...
  self->settings = g_settings_new ("io.github.gnome_de.ControlCenter");
