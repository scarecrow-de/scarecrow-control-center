...
setup_scroll_image (CcMouseTest *self)
{
	...
	if (self->double_click_state == DOUBLE_CLICK_TEST_GEGL)
		resource = "/io.github.scarecrow-de.control-center/mouse/scroll-test-gegl.svg";
	else
		resource = "/io.github.scarecrow-de.control-center/mouse/scroll-test.svg";
...
cc_mouse_test_class_init (CcMouseTestClass *klass)
{
	...
	gtk_widget_class_set_template_from_resource (widget_class, "/io.github.scarecrow-de.control-center/mouse/cc-mouse-test.ui");
...
cc_mouse_test_init (CcMouseTest *self)
{
	...
	self->mouse_settings = g_settings_new ("io.github.scarecrow-de.settings-daemon.peripherals.mouse");
