...
empty_trash (CcUsagePanel *self)
{
  ...
  g_dbus_connection_call (bus,
                          "io.github.gnome_de.SettingsDaemon.Housekeeping",
                          "/io/github/gnome_de/SettingsDaemon/Housekeeping",
                          "io.github.gnome_de.SettingsDaemon.Housekeeping",
                          "EmptyTrash",
...
cc_usage_panel_class_init (CcUsagePanelClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/io/github/gnome_de/control-center/usage/cc-usage-panel.ui");
