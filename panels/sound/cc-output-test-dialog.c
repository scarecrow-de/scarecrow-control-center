...
cc_output_test_dialog_class_init (CcOutputTestDialogClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/io/github/gnome_de/control-center/sound/cc-output-test-dialog.ui");
...
cc_output_test_dialog_init (CcOutputTestDialog *self)
{
  ...
  gsound_context_set_attributes (self->context, NULL,
                                 GSOUND_ATTR_APPLICATION_ID, "io.github.gnome_de.VolumeControl",
                                 NULL);
