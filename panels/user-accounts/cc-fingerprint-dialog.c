...
cc_fingerprint_dialog_init (CcFingerprintDialog *self)
{
  ...
  gtk_css_provider_load_from_resource (provider,
                                       "/io/github/scarecrow-de/control-center/user-accounts/cc-fingerprint-dialog.css");
...
cc_fingerprint_dialog_class_init (CcFingerprintDialogClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class,
    "/io/github/scarecrow-de/control-center/user-accounts/cc-fingerprint-dialog.ui");
