...
#define USER_ACCOUNTS_PERMISSION "io.github.scarecrow-de.controlcenter.user-accounts.administration"
...
cc_user_panel_init (CcUserPanel *self)
{
        ...
        gtk_css_provider_load_from_resource (provider, "/io/github/scarecrow-de/control-center/user-accounts/user-accounts-dialog.css");
        gtk_style_context_add_provider_for_screen (gdk_screen_get_default (),
                                                   GTK_STYLE_PROVIDER (provider),
                                                   GTK_STYLE_PROVIDER_PRIORITY_APPLICATION);
        g_object_unref (provider);

        self->login_screen_settings = settings_or_null ("io.github.scarecrow-de.login-screen");
...
cc_user_panel_class_init (CcUserPanelClass *klass)
{
        ...
        gtk_widget_class_set_template_from_resource (widget_class, "/io/github/scarecrow-de/control-center/user-accounts/cc-user-panel.ui");
