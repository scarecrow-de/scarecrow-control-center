...
join_init (CcAddUserDialog *self)
{
        ...
        if (!gtk_builder_add_from_resource (builder,
                                            "/io/github/scarecrow-de/control-center/user-accounts/join-dialog.ui",
                                            &error)) {
...
cc_add_user_dialog_class_init (CcAddUserDialogClass *klass)
{
        ...
        gtk_widget_class_set_template_from_resource (widget_class, "/io/github/scarecrow-de/control-center/user-accounts/cc-add-user-dialog.ui");
