...
cc_power_panel_class_init (CcPowerPanelClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/io/github/gnome_de/control-center/power/cc-power-panel.ui");
...
load_custom_css (CcPowerPanel *self)
{
  ...
  gtk_css_provider_load_from_resource (provider, "/io/github/gnome_de/control-center/power/battery-levels.css");
                ...
                gboolean      powered)
{
  g_dbus_proxy_call (self->bt_properties,
		     "Set",
		     g_variant_new_parsed ("('io.github.gnome_de.SettingsDaemon.Rfkill', 'BluetoothAirplaneMode', %v)",
...
add_power_saving_section (CcPowerPanel *self)
{
  ...
  self->bt_rfkill = cc_object_storage_create_dbus_proxy_sync (G_BUS_TYPE_SESSION,
                                                              G_DBUS_PROXY_FLAGS_NONE,
                                                              "io.github.gnome_de.SettingsDaemon.Rfkill",
                                                              "/io/github/gnome_de/SettingsDaemon/Rfkill",
                                                              "io.github.gnome_de.SettingsDaemon.Rfkill",
                                                              NULL,
                                                              NULL);
...
<<<<<<< Updated upstream
  self->gsd_settings = g_settings_new ("io.github.gnome_de.settings-daemon.plugins.power");
  self->session_settings = g_settings_new ("io.github.gnome_de.desktop.session");
  self->interface_settings = g_settings_new ("io.github.gnome_de.desktop.interface");
=======
