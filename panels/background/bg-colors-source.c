...
{
  return g_build_filename (g_get_user_config_dir (), "scarecrow-control-center", "backgrounds", "colors.ini", NULL);
}

static char *
get_colors_dir (void)
{
  return g_build_filename (g_get_user_config_dir (), "scarecrow-control-center", "backgrounds", NULL);
}
                            ...
                            const char                   *color)
{
  ...
  g_object_set (G_OBJECT (item),
                "uri", "file:///" DATADIR "/scarecrow-control-center/pixmaps/noise-texture-light.png",
                "primary-color", color,
