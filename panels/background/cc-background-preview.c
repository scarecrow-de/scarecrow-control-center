...
load_custom_css (CcBackgroundPreview *self)
{
  ...
  gtk_css_provider_load_from_resource (provider, "/io/github/scarecrow_de/control-center/background/preview.css");
...
cc_background_preview_class_init (CcBackgroundPreviewClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/io/github/scarecrow_de/control-center/background/cc-background-preview.ui");
...
cc_background_preview_init (CcBackgroundPreview *self)
{
  ...
  self->thumbnail_factory = scarecrow_desktop_thumbnail_factory_new (SCARECROW_DESKTOP_THUMBNAIL_SIZE_LARGE);
