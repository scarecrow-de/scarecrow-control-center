...
#define WP_PATH_ID "io.github.gnome_de.desktop.background"
#define WP_LOCK_PATH_ID "io.github.gnome_de.desktop.screensaver"
...
cc_background_panel_class_init (CcBackgroundPanelClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/io/github/gnome_de/control-center/background/cc-background-panel.ui");
