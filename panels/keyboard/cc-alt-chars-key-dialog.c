...
cc_alt_chars_key_dialog_class_init (CcAltCharsKeyDialogClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/io/github/gnome_de/control-center/keyboard/cc-alt-chars-key-dialog.ui");
...
cc_alt_chars_key_dialog_init (CcAltCharsKeyDialog *self)
{
  ...
  self->input_source_settings = g_settings_new ("io.github.gnome_de.desktop.input-sources");
