...
enable_switch_changed_cb (CcBluetoothPanel *self)
{
	...
	g_dbus_proxy_call (self->properties,
			   "Set",
			   g_variant_new_parsed ("('io.github.scarecrow_de.SettingsDaemon.Rfkill', 'BluetoothAirplaneMode', %v)",
...
airplane_mode_off_button_clicked_cb (CcBluetoothPanel *self)
{
	...
	g_dbus_proxy_call (self->rfkill,
			   ...
			   g_variant_new_parsed ("('io.github.scarecrow_de.SettingsDaemon.Rfkill',"
						 "'AirplaneMode', %v)",
...
cc_bluetooth_panel_class_init (CcBluetoothPanelClass *klass)
{
	...
	gtk_widget_class_set_template_from_resource (widget_class, "/io/github/scarecrow_de/control-center/bluetooth/cc-bluetooth-panel.ui");
