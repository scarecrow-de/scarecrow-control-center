...
/* shell settings */
#define A11Y_SETTINGS               "io.github.gnome_de.desktop.a11y"
#define KEY_ALWAYS_SHOW_STATUS       "always-show-universal-access-status"

/* interface settings */
#define INTERFACE_SETTINGS           "io.github.gnome_de.desktop.interface"
...
#define APPLICATION_SETTINGS         "io.github.gnome_de.desktop.a11y.applications"
...
/* wm settings */
#define WM_SETTINGS                  "io.github.gnome_de.desktop.wm.preferences"
#define KEY_VISUAL_BELL_ENABLED      "visual-bell"
#define KEY_VISUAL_BELL_TYPE         "visual-bell-type"
#define KEY_WM_THEME                 "theme"

/* keyboard settings */
#define KEYBOARD_SETTINGS            "io.github.gnome_de.desktop.a11y.keyboard"
...
#define KEYBOARD_DESKTOP_SETTINGS    "io.github.gnome_de.desktop.peripherals.keyboard"
#define KEY_REPEAT_KEYS              "repeat"

/* mouse settings */
#define MOUSE_SETTINGS               "io.github.gnome_de.desktop.a11y.mouse"
...
#define GSD_MOUSE_SETTINGS           "io.github.gnome_de.settings-daemon.peripherals.mouse"
...
{ 
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/io/github/gnome_de/control-center/universal-access/cc-ua-panel.ui");
  ...
  for (i = 0; i < G_N_ELEMENTS(cursor_sizes); i++)
    {
      ...
      cursor_image_name = g_strdup_printf ("/io/github/gnome_de/control-center/universal-access/left_ptr_%dpx.png", cursor_sizes[i]);
