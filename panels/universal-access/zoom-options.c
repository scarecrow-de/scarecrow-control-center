...
zoom_options_class_init (ZoomOptionsClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/io/github/gnome_de/control-center/universal-access/zoom-options.ui");
...
zoom_options_init (ZoomOptions *self)
{
  ...
  self->settings = g_settings_new ("io.github.gnome_de.desktop.a11y.magnifier");
  self->application_settings = g_settings_new ("io.github.gnome_de.desktop.a11y.applications");
}
