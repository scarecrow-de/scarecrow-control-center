...
#define MEDIA_HANDLING_SCHEMA "io.github.scarecrow-de.desktop.media-handling"
...
cc_removable_media_panel_class_init (CcRemovableMediaPanelClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/io/github/scarecrow-de/control-center/removable-media/cc-removable-media-panel.ui");
