...
#define DISPLAY_SCHEMA   "io.github.gnome_de.settings-daemon.plugins.color"
                             ...
                             CcNightLightPage *self)
{
  g_dbus_proxy_call (self->proxy_color_props,
                     "Set",
                     g_variant_new ("(ssv)",
                                    "io.github.gnome_de.SettingsDaemon.Color",
                                    "DisabledUntilTomorrow",
...
cc_night_light_page_class_init (CcNightLightPageClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/io/github/gnome_de/control-center/display/cc-night-light-page.ui");
...
cc_night_light_page_init (CcNightLightPage *self)
{
  ...
  gtk_css_provider_load_from_resource (provider, "/io/github/gnome_de/control-center/display/night-light.css");
