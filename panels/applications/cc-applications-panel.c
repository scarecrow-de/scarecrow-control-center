...
#define MASTER_SCHEMA "io.github.gnome_de.desktop.notifications"
#define APP_SCHEMA MASTER_SCHEMA ".application"
#define APP_PREFIX "/io/github/gnome_de/desktop/notifications/application/"
...
cc_applications_panel_class_init (CcApplicationsPanelClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/io/github/gnome_de/control-center/applications/cc-applications-panel.ui");
...
cc_applications_panel_init (CcApplicationsPanel *self)
{
  ...
  gtk_css_provider_load_from_resource (GTK_CSS_PROVIDER (provider),
                                       "/io/github/gnome_de/control-center/applications/cc-applications-panel.css");
  ...
  self->location_settings = g_settings_new ("io.github.gnome_de.system.location");
  self->privacy_settings = g_settings_new ("io.github.gnome_de.desktop.privacy");
  self->search_settings = g_settings_new ("io.github.gnome_de.desktop.search-providers");
#ifdef HAVE_MALCONTENT
