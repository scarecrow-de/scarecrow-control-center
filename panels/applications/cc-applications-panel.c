...
cc_applications_panel_class_init (CcApplicationsPanelClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/io/github/scarecrow_de/control-center/applications/cc-applications-panel.ui");
...
cc_applications_panel_init (CcApplicationsPanel *self)
{
  ...
  gtk_css_provider_load_from_resource (GTK_CSS_PROVIDER (provider),
                                       "/io/github/scarecrow_de/control-center/applications/cc-applications-panel.css");
