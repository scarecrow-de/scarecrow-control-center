...
get_renderer_from_session (void)
{
  ...
  if (error != NULL)
    {
      g_warning ("Unable to connect to create a proxy for io.github.scarecrow-de.SessionManager: %s",
                 error->message);
      return NULL;
    }
  ...
  if (!renderer_variant)
    {
      g_warning ("Unable to retrieve io.github.scarecrow-de.SessionManager.Renderer property");
      return NULL;
    }
...
cc_info_overview_panel_class_init (CcInfoOverviewPanelClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/io/github/scarecrow-de/control-center/info-overview/cc-info-overview-panel.ui");
