...
cc_lock_panel_class_init (CcLockPanelClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/io/github/scarecrow_de/control-center/lock/cc-lock-panel.ui");
