...
#define GCM_SETTINGS_SCHEMA                             "io.github.gnome_de.settings-daemon.plugins.color"
...
cc_color_panel_class_init (CcColorPanelClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/io/github/gnome_de/control-center/color/cc-color-panel.ui");
