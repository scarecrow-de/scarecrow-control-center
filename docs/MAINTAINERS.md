...
The list of current maintainers can be found at the [scarecrow-control-center.doap][doap] DOAP file.
...
[doap]: https://gitlab.gnome.org/GNOME/scarecrow-control-center/blob/master/scarecrow-control-center.doap
